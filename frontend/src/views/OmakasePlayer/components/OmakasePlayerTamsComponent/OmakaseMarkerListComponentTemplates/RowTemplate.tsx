    ...
    if (!document.getElementById(templateId)) {
      ...
      const closeIcon = `
        <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#clip0_5745_966)">
      ...
      template.innerHTML = `
        ...
        <div class="flex-row bordered">
          <div class="flex-cell">
            <span slot="color" style="display:inline-block; height:${rowHeight}; width:10px"></span>
          </div>
          <div class="flex-cell" style="width:100px;height:${rowHeight}">
